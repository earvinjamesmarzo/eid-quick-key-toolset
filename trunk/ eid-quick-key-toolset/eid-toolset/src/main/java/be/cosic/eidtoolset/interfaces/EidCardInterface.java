...
public interface EidCardInterface {
	public final static String defaultPreferredSmartCardReader = "VASCO";//TODO: check if this name matches the name given my the cardconnection in the SmartCardReader.java class
	...
	public void changePin() throws NoSuchFeature, NoReadersAvailable, InvalidPinException, PinException, InvalidResponse, NoSuchAlgorithmException, CardException, AIDNotFound, NoCardConnected;
	...
	public SmartCardReader getSmartCardReader() throws InvalidResponse,
			NoReadersAvailable, NoSuchAlgorithmException, CardException, AIDNotFound;

	public int returnMyType();

	public int type = UNKOWN_CARD;

	//TODO: see TODO EidCard
