...
public class CarolineEidCard extends SampleEidCard {
	...
	public static void install(byte[] bArray, short bOffset, byte bLength) {
		...
		// create a Caroline eID card applet instance
		new CarolineEidCard();

	}

	private CarolineEidCard() {
	...
	private void initializePrivateKeys() {
		 ...
		 * 
		 * $ openssl pkcs12 -in "Caroline SPECIMEN Authentication.p12" -nodes 
		 *   -out Caroline_Authentication.pem
		 * Enter Import Password: Certipost0.
		 * $ openssl rsa -in Caroline_Authentication.pem -text -noout
		 */
		authPrivateKey =
		 ...
		 * extracted from http://www.eid-shop.be/media/certificates.zip
		 * 
		 * $ openssl pkcs12 -in "Caroline SPECIMEN Signature.p12" -nodes 
		 *   -out Caroline_Signature.pem
		 * Enter Import Password: Certipost0.
		 * $ openssl rsa -in Caroline_Signature.pem -text -noout
		 */
		nonRepPrivateKey =
			(RSAPrivateCrtKey)KeyBuilder.buildKey(
				KeyBuilder.TYPE_RSA_CRT_PRIVATE,
