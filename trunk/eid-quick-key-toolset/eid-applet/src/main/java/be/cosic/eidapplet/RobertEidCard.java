...
public class RobertEidCard extends SampleEidCard {
	...
	public static void install(byte[] bArray, short bOffset, byte bLength) {
		...
		// create a Robert eID card applet instance
		new RobertEidCard();

	}

	private RobertEidCard() {
	...
	private void initializePrivateKeys() {
		 ...
		 * 
		 * $ openssl pkcs12 -in "Robert SPECIMEN Authentication.p12" -nodes 
		 *   -out Robert_Authentication.pem
		 * Enter Import Password: Certipost0.
		 * $ openssl rsa -in Robert_Authentication.pem -text -noout
		 */
		authPrivateKey =
		 ...
		 * extracted from http://www.eid-shop.be/media/certificates.zip
		 * 
		 * $ openssl pkcs12 -in "Robert SPECIMEN Signature.p12" -nodes 
		 *   -out Robert_Signature.pem
		 * Enter Import Password: Certipost0.
		 * $ openssl rsa -in Robert_Signature.pem -text -noout
		 */
		nonRepPrivateKey =
			(RSAPrivateCrtKey)KeyBuilder.buildKey(
				KeyBuilder.TYPE_RSA_CRT_PRIVATE,
