...
import be.cosic.util.ExampleFileFilter;
...
//	
	...
	//TODO html help toeveogen
	
	//TODO replace all // by File.separator for OS compatibility
	...
	*/
	...
	private void jMenu2WriteActionPerformed(ActionEvent evt) {
		...
		try {
			...
			//TODO this does not change the full ATR: only historical bytes part
			//belpic.changeATR();
...
/**
 * This thread is caled upon launching the GUI to extract the necessary jar files 
